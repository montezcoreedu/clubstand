        ...
        if (isset($_FILES['csv_file'])) {
            ...
            if ($fileError === UPLOAD_ERR_OK) {
                ...
                while (($data = fgetcsv($file)) !== FALSE) {
                    ...
                    $CellPhone = !empty($row['CellPhone']) ? mysqli_real_escape_string($conn, $row['CellPhone']) : NULL;
                    ...
                    $sql = "INSERT INTO members (
                                LastName, FirstName, Suffix, Position, EmailAddress, CellPhone, GradeLevel, Birthdate, Gender, Ethnicity, ShirtSize,
                                ...
                                '$LastName', '$FirstName', '$Suffix', " . ($Position ? "'$Position'" : "NULL") . ", '$EmailAddress', " . ($CellPhone ? "'$CellPhone'" : "NULL") . ", $GradeLevel, " .
